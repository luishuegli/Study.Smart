...
$\Rightarrow$ **Dependent** (not independent)."""
    ...
    "hs2024_mc3": {
        ...
        "correct_idx": 2,
        "solution": {
            "de": "**Schritt 1: Formel aufstellen**<br>$P(A|\\overline{B}) = \\frac{P(A \\cap \\overline{B})}{P(\\overline{B})}$<br><br>**Schritt 2: Nenner berechnen**<br>$P(\\overline{B}) = 1 - P(B) = 1 - \\frac{2}{3} = \\frac{1}{3}$.<br><br>**Schritt 3: Zähler berechnen**<br>$P(A \\cap \\overline{B})$ ist 'A ohne B'.<br>$P(A \\cap \\overline{B}) = P(A) - P(A \\cap B) = \\frac{1}{2} - \\frac{1}{4} = \\frac{1}{4}$.<br><br>**Schritt 4: Einsetzen**<br>$\\frac{1/4}{1/3} = \\frac{1}{4} \\cdot \\frac{3}{1} = \\frac{3}{4} = \\mathbf{0.75}$.",
            "en": "**Step 1: Setup Formula**<br>$P(A|\\overline{B}) = \\frac{P(A \\cap \\overline{B})}{P(\\overline{B})}$<br><br>**Step 2: Calculate Denominator**<br>$P(\\overline{B}) = 1 - P(B) = 1 - \\frac{2}{3} = \\frac{1}{3}$.<br><br>**Step 3: Calculate Numerator**<br>$P(A \\cap \\overline{B})$ is 'A without B'.<br>$P(A \\cap \\overline{B}) = P(A) - P(A \\cap B) = \\frac{1}{2} - \\frac{1}{4} = \\frac{1}{4}$.<br><br>**Step 4: Solve**<br>$\\frac{1/4}{1/3} = \\frac{1}{4} \\cdot \\frac{3}{1} = \\frac{3}{4} = \\mathbf{0.75}$."
        },
        "hint": {
